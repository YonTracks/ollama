...
export function OfflineAppShell() {
  return (
    <main className="page-safe-padding flex min-h-dvh items-center justify-center bg-background text-foreground">
      <div className="w-full max-w-[calc(100vw-2rem)] rounded-md border border-border bg-panel p-5 text-center shadow-panel sm:max-w-sm sm:p-6">
